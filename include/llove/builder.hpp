...
#pragma region WRAPPER
        ...
        llvm::Value *CreateDiv(
            ...
            const std::string &name = {},
            bool is_exact = false);
        llvm::Value *CreateRem(bool is_signed, llvm::Value *left, llvm::Value *right, const std::string &name = {});
...
#pragma endregion
        ...
        FunctionReference GenFunction(const Function &function, bool register_function);
