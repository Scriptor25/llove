...
#pragma region WRAPPER
        ...
        llvm::Value* CreateCmpEQ(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateCmpNE(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateCmpLT(
            bool is_signed,
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateCmpLE(
            bool is_signed,
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateCmpGT(
            bool is_signed,
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateCmpGE(
            bool is_signed,
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});

        llvm::Value* CreateFCmpEQ(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateFCmpNE(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateFCmpLT(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateFCmpLE(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateFCmpGT(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreateFCmpGE(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});

        llvm::Value* CreatePCmpEQ(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
        llvm::Value* CreatePCmpNE(
            llvm::Value* left,
            llvm::Value* right,
            const std::string& name = {});
...
#pragma endregion
        ...
        ValuePtr GetPointerElement(
            const ValuePtr& pointer,
            const ValuePtr& index);
        ValuePtr GetArrayElement(
