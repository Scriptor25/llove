...
llvm::Constant* llove::Builder::GetStr(
...
llvm::StoreInst* llove::Builder::CreateStore(
    llvm::Value* value,
    llvm::Value* pointer,
    const bool is_volatile)
{
...
llvm::Value* llove::Builder::CreateExtractValue(
...
llvm::Value* llove::Builder::CreateMul(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateAnd(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateOr(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateXor(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateLogicalAnd(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateLogicalOr(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFAdd(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFSub(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFMul(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFDiv(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFRem(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateNeg(
    llvm::Value* value,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFNeg(
    llvm::Value* value,
    const std::string& name)
{
    Assert(value != nullptr, "operand must not be null");
...
llvm::Value* llove::Builder::CreateNot(
    llvm::Value* value,
    const std::string& name)
{
    Assert(value != nullptr, "operand must not be null");
...
llvm::Value* llove::Builder::CreateCmpEQ(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateCmpNE(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFCmpEQ(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFCmpNE(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFCmpLT(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFCmpLE(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFCmpGT(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateFCmpGE(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreatePCmpEQ(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreatePCmpNE(
    llvm::Value* left,
    llvm::Value* right,
    const std::string& name)
{
...
llvm::Value* llove::Builder::CreateIsNotNull(
    llvm::Value* value,
    const std::string& name)
{
    Assert(value != nullptr, "value must not be null");
...
llvm::Value* llove::Builder::CreateIsNull(
    llvm::Value* value,
    const std::string& name)
{
    Assert(value != nullptr, "value must not be null");
...
llvm::SwitchInst* llove::Builder::CreateSwitch(
    ...
    const std::map<
        llvm::ConstantInt*,
        llvm::BasicBlock*>& cases)
{
    Assert(condition != nullptr, "condition must not be null");
    Assert(default_block != nullptr, "default block must not be null");

    const auto instruction = m_LLVMBuilder.CreateSwitch(
        condition,
        default_block,
        cases.size());
...
llvm::PHINode* llove::Builder::CreatePHI(
    llvm::Type* type,
    const std::map<
        llvm::BasicBlock*,
        llvm::Value*>& operands)
...
llvm::CallInst* llove::Builder::CreateMemcpy(
    llvm::Value* dst,
    llvm::Value* src,
    llvm::Value* count)
{
...
llvm::BasicBlock* llove::Builder::CreateBlock(
    const std::string& name,
    llvm::Function* parent)
{
