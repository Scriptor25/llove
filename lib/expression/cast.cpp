...
llove::CastExpression::CastExpression(Location loc, ExpressionPtr value, TypePtr type)
...
llove::ValuePtr llove::CastExpression::GenVal(Builder &builder, TypePtr expect) const try
{
