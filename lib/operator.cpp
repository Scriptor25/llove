...
llove::ValuePtr llove::BIOperator<2>::operator()(Builder &builder, ValuePtr left, ValuePtr right) const
{
...
llove::ValuePtr llove::UDOperator<2>::operator()(Builder &builder, ValuePtr left, ValuePtr right) const
{
    std::vector<ValuePtr> arguments;
    ValuePtr self;
