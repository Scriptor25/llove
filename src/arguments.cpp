...
static std::vector<std::string> split_string(std::string value, const char delimiter)
{
...
{
    const auto pred = [&id_set](const std::string &id) -> bool
    {
...
bool cli::Arguments::value(const std::string &id, std::string &dst) const
{
...
bool cli::Arguments::array(const std::string &id, std::vector<std::string> &dst) const
{
    if (!m_Arrays.contains(id))
        return false;
    dst = m_Arrays.at(id);
...
bool cli::Arguments::has_value_and_is(const std::string &id, const std::string &value) const
{
    return m_Values.contains(id) && m_Values.at(id) == value;
}

bool cli::Arguments::has_value_and_is_not(const std::string &id, const std::string &value) const
{
    return m_Values.contains(id) && m_Values.at(id) != value;
}
