...
template<>
bool cli::convert_value(
    llvm::DICompileUnit::DebugEmissionKind& dst,
    const std::string& value)
{
...
template<>
bool cli::convert_value(
    llvm::SwiftAsyncFramePointerMode& dst,
    const std::string& value)
{
...
template<>
bool cli::convert_value(
    llvm::FPOpFusion::FPOpFusionMode& dst,
    const std::string& value)
{
...
template<>
bool cli::convert_value(
    llvm::DenormalMode::DenormalModeKind& dst,
    const std::string& value)
{
...
template<>
bool cli::convert_value(
    llvm::MCTargetOptions::DwarfDirectory& dst,
    const std::string& value)
{
